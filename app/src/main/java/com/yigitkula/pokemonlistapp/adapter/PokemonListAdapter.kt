...
class PokemonListAdapter(val pokemonList: ArrayList<Pokemon>) :RecyclerView.Adapter<PokemonListAdapter.MyViewHolder>(), ItemClickListener {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.view.listener = this
          /*  //List Fragment Data
            holder.view.pokeLName.text=pokemonList[position].pokemonName

            holder.view.setOnClickListener{
                val action = ListFragmentDirections.actionListFragmentToDetailFragment(pokemonList[position].uuid)
